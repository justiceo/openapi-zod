...
echo "above. Major and minor version bumps are safe to commit here too —"
echo "they're guarded by the test suite (pre-commit lint/typecheck/test),"
echo "so a green suite after updating is sufficient to commit."
exit 0
