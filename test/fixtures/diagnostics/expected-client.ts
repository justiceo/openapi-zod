...
export async function missingPathParam(config: ClientConfig, input: ClientOperationInput<typeof missingPathParamOperation.request> = {}, options?: ClientOptions): Promise<ClientResult<ClientResponseData<typeof missingPathParamOperation.responses>>> {
  return clientRequest(config, missingPathParamOperation, input, options);
}

export async function noResponses(config: ClientConfig, input: ClientOperationInput<typeof noResponsesOperation.request> = {}, options?: ClientOptions): Promise<ClientResult<ClientResponseData<typeof noResponsesOperation.responses>>> {
  return clientRequest(config, noResponsesOperation, input, options);
}

export async function upload(config: ClientConfig, input: ClientOperationInput<typeof uploadOperation.request> = {}, options?: ClientOptions): Promise<ClientResult<ClientResponseData<typeof uploadOperation.responses>>> {
  return clientRequest(config, uploadOperation, input, options);
}

export function createClient(config: ClientConfig) {
  return {
    missingPathParam: (input?: ClientOperationInput<typeof missingPathParamOperation.request>, options?: ClientOptions) => missingPathParam(config, input, options),
    noResponses: (input?: ClientOperationInput<typeof noResponsesOperation.request>, options?: ClientOptions) => noResponses(config, input, options),
    upload: (input?: ClientOperationInput<typeof uploadOperation.request>, options?: ClientOptions) => upload(config, input, options),
  };
}
