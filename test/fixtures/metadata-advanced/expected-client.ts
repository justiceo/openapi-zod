...
export async function getMeta(config: ClientConfig, input: ClientOperationInput<typeof getMetaOperation.request> = {}, options?: ClientOptions): Promise<ClientResult<ClientResponseData<typeof getMetaOperation.responses>>> {
  return clientRequest(config, getMetaOperation, input, options);
}

export function createClient(config: ClientConfig) {
  return {
    getMeta: (input?: ClientOperationInput<typeof getMetaOperation.request>, options?: ClientOptions) => getMeta(config, input, options),
  };
}
