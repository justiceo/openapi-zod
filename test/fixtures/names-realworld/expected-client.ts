...
export async function Schema2024reportlookup(config: ClientConfig, input: ClientOperationInput<typeof Schema2024reportlookupOperation.request> = {}, options?: ClientOptions): Promise<ClientResult<ClientResponseData<typeof Schema2024reportlookupOperation.responses>>> {
  return clientRequest(config, Schema2024reportlookupOperation, input, options);
}

export function createClient(config: ClientConfig) {
  return {
    Schema2024reportlookup: (input?: ClientOperationInput<typeof Schema2024reportlookupOperation.request>, options?: ClientOptions) => Schema2024reportlookup(config, input, options),
  };
}
