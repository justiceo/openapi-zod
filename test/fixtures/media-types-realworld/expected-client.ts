...
export async function importDocument(config: ClientConfig, input: ClientOperationInput<typeof importDocumentOperation.request> = {}, options?: ClientOptions): Promise<ClientResult<ClientResponseData<typeof importDocumentOperation.responses>>> {
  return clientRequest(config, importDocumentOperation, input, options);
}

export function createClient(config: ClientConfig) {
  return {
    importDocument: (input?: ClientOperationInput<typeof importDocumentOperation.request>, options?: ClientOptions) => importDocument(config, input, options),
  };
}
