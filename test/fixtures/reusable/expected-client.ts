...
import { createItemOperation, readItemOperation } from "./operations";
...
export async function createItem(config: ClientConfig, input: ClientOperationInput<typeof createItemOperation.request> = {}, options?: ClientOptions): Promise<ClientResult<ClientResponseData<typeof createItemOperation.responses>>> {
  return clientRequest(config, createItemOperation, input, options);
}

export async function readItem(config: ClientConfig, input: ClientOperationInput<typeof readItemOperation.request> = {}, options?: ClientOptions): Promise<ClientResult<ClientResponseData<typeof readItemOperation.responses>>> {
  return clientRequest(config, readItemOperation, input, options);
}

export function createClient(config: ClientConfig) {
  return {
    createItem: (input?: ClientOperationInput<typeof createItemOperation.request>, options?: ClientOptions) => createItem(config, input, options),
    readItem: (input?: ClientOperationInput<typeof readItemOperation.request>, options?: ClientOptions) => readItem(config, input, options),
  };
}
