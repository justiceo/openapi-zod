...
import { createOrderOperation } from "./operations.js";
...
export async function createOrder(config: ClientConfig, input: ClientOperationInput<typeof createOrderOperation.request> = {}, options?: ClientOptions): Promise<ClientResult<ClientResponseData<typeof createOrderOperation.responses>>> {
  return clientRequest(config, createOrderOperation, input, options);
}

export function createClient(config: ClientConfig) {
  return {
    createOrder: (input?: ClientOperationInput<typeof createOrderOperation.request>, options?: ClientOptions) => createOrder(config, input, options),
  };
}
