...
import { ingestEventOperation } from "./operations.js";
...
export async function ingestEvent(config: ClientConfig, input: ClientOperationInput<typeof ingestEventOperation.request> = {}, options?: ClientOptions): Promise<ClientResult<ClientResponseData<typeof ingestEventOperation.responses>>> {
  return clientRequest(config, ingestEventOperation, input, options);
}

export function createClient(config: ClientConfig) {
  return {
    ingestEvent: (input?: ClientOperationInput<typeof ingestEventOperation.request>, options?: ClientOptions) => ingestEvent(config, input, options),
  };
}
