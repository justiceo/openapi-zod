...
export async function getCategory(config: ClientConfig, input: ClientOperationInput<typeof getCategoryOperation.request> = {}, options?: ClientOptions): Promise<ClientResult<ClientResponseData<typeof getCategoryOperation.responses>>> {
  return clientRequest(config, getCategoryOperation, input, options);
}

export function createClient(config: ClientConfig) {
  return {
    getCategory: (input?: ClientOperationInput<typeof getCategoryOperation.request>, options?: ClientOptions) => getCategory(config, input, options),
  };
}
