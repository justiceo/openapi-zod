...
import { getBrokenOperation } from "./operations.js";
...
export async function getBroken(config: ClientConfig, input: ClientOperationInput<typeof getBrokenOperation.request> = {}, options?: ClientOptions): Promise<ClientResult<ClientResponseData<typeof getBrokenOperation.responses>>> {
  return clientRequest(config, getBrokenOperation, input, options);
}

export function createClient(config: ClientConfig) {
  return {
    getBroken: (input?: ClientOperationInput<typeof getBrokenOperation.request>, options?: ClientOptions) => getBroken(config, input, options),
  };
}
