...
import { getUserOperation, updateUserOperation } from "./operations.js";
...
export async function getUser(config: ClientConfig, input: ClientOperationInput<typeof getUserOperation.request> = {}, options?: ClientOptions): Promise<ClientResult<ClientResponseData<typeof getUserOperation.responses>>> {
...
export function createClient(config: ClientConfig) {
  return {
    getUser: (input?: ClientOperationInput<typeof getUserOperation.request>, options?: ClientOptions) => getUser(config, input, options),
