...
export async function updateProfile(config: ClientConfig, input: ClientOperationInput<typeof updateProfileOperation.request> = {}, options?: ClientOptions): Promise<ClientResult<ClientResponseData<typeof updateProfileOperation.responses>>> {
  return clientRequest(config, updateProfileOperation, input, options);
}

export function createClient(config: ClientConfig) {
  return {
    updateProfile: (input?: ClientOperationInput<typeof updateProfileOperation.request>, options?: ClientOptions) => updateProfile(config, input, options),
  };
}
